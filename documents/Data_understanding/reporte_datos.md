...
- [ ] Hay desbalanceo de datos, la clase (CLASS) **Y** es, aproximadamente, 8 veces la clase **N** y 16 veces la clase **P** como se observa en las Figura 1.<br>

<div style="text-align: center;">
  <p align="center">
    <img src="/documents/Data_understanding/data_img/EDA_distribucion_clases_barplot.png" alt="drawing" width="300px" height='300px'/>
    <img src="/documents/Data_understanding/data_img/EDA_distribucion_genero_countplot.png" alt="drawing" width="600" height='300px'/>
  </p>
</div>
<p align="center"><b>Figura 1. Diagrama de Barras de las variables género (Gender) y clase (CLASS)</b></p>
...
<p align="center"><b>Tabla 1. Medidas de tendencia central para el vector de características</b></p>
<br>
...
<p align="center"><b>Figura 2. Distribución de las carecterísticas numéricas</b></p><br>
...
<p align="center"><b>Figura 3. Graficas QQ </b></p><br>
<p align="center">
  <img src="/documents/Data_understanding/data_img/EDA_distribucion_edad_histplot.png" width="500" height='300px'/>
</p>
<p align="center"><b>Figura 4. Graficas QQ para la variable EDAD (AGE)</b></p><br>
...
<p align="center"><b>Figura 5.Matriz de correlación</b></p><br>
<img src="/documents/Data_understanding/data_img/EDA_relacion_genero.png" alt="drawing" width="1000" height='500px'/>
<p align="center"><b>Figura 5. Cajas y bigotes por género.</b></p><br>
...
<p align="center"><b>Figura 6. Cajas y bigotes por clase.</b></p><br>
